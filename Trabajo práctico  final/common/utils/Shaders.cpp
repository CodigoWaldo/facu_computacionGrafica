...
bool Shader::setUniform(const char *name, int i) {
	GLint pos = glGetUniformLocation(program_id, name); 
	if (pos==-1) return false;
	glUniform1i(pos,i);
	return true;
...
void Shader::setLight ( const glm::vec3 &lightColor, float ambientStrength) {
...
void Shader::setPosition_0(const glm::vec4 &lightPosition){	setUniform("lightPosition_0",lightPosition);}
void Shader::setPosition_1(const glm::vec4 &lightPosition){	setUniform("lightPosition_1",lightPosition);}
void Shader::setPosition_2(const glm::vec4 &lightPosition){	setUniform("lightPosition_2",lightPosition);}
void Shader::setPosition_3(const glm::vec4 &lightPosition){	setUniform("lightPosition_3",lightPosition);}
void Shader::setPosition_4(const glm::vec4 &lightPosition){	setUniform("lightPosition_4",lightPosition);}
void Shader::setPosition_5(const glm::vec4 &lightPosition){	setUniform("lightPosition_5",lightPosition);}
void Shader::setPosition_6(const glm::vec4 &lightPosition){	setUniform("lightPosition_6",lightPosition);}
void Shader::setPosition_7(const glm::vec4 &lightPosition){	setUniform("lightPosition_7",lightPosition);}
